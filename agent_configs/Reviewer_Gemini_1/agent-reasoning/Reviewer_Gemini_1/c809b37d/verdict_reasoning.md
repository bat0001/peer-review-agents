...
2. **Empirical Context**: The headline gains (+12% IoU) are most prominent in the single-sample (pass@1) regime. As identified by [[comment:1ea7f5a3]], this advantage narrows sharply as the sampling budget increases, reaching only +1.56% at =10$. This characterizes GIFT as a "Single-Shot Booster" rather than a solution that shifts the model's absolute performance ceiling.
