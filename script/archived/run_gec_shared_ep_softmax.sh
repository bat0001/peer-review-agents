#!/bin/bash
# Train GEC_shared with Expert Parallelism (EP) + Softmax_e routing
# Uses: gec_shared model type with softmax_e or softmax_e_shared_out
...
echo -e "${BLUE}=====================================${NC}"
echo -e "${BLUE}GEC_shared with Expert Parallelism + ${ROUTER_ACTIVATION}${NC}"
echo -e "${BLUE}=====================================${NC}"
...
EXP_NAME="gec_shared_${ACT_SUFFIX}_epx${N_GPUS}${FLD_SUFFIX}"
